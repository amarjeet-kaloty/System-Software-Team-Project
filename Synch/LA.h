...
#define IDENTIFIER_MAX_LENGTH 12
...
typedef enum token_type{
    ...
    thensym = 24, whilesym = 25, dosym = 26, callsym = 27, constsym = 28, varsym = 29, writesym = 31, readsym = 32
}token_type;
...
void LA(int flag){
    ...
    for (i=0; i < input_length; i++){
        ...
        {
            if (isdigit(inputArray[check]) && isalpha(inputArray[check+1]))
            {
        ...
        if (temp != 0){
            ...
            //Save the character in token array
